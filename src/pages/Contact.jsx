...
export default function Contact() {
  ...
  return (
    ...
    >
      <div
        className="card shadow-lg p-5 rounded-4 w-100 mx-auto d-flex align-items-center justify-content-center"
        style={{ maxWidth: "900px", minHeight: "50vh", background: "#fff" }}
      >
        <div className="card-body text-center d-flex flex-column justify-content-center align-items-center w-100">
          <h1
            className="card-title mb-4 fw-bold text-center display-3"
            style={{ color: "#0d6efd", letterSpacing: "2px" }}
          >
            Contact Us
          </h1>
          {submitted ? (
            <div className="alert alert-success text-center fs-4">
            ...
            >
              ...
              <button
                type="submit"
                className="btn btn-primary w-100 rounded-pill shadow-sm fs-5 py-2"
              >
                Send
              </button>
            </form>
